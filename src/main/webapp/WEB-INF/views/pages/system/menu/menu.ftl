...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li><a href="#/system/menu">菜单管理<i class="fa fa-angle-right"></i></a></li>
    <li>菜单管理</li>
  </ul>
  <!--.page-toolbar
  ...
  <div class="col-md-12">
    <div class="portlet light portlet-fit portlet-form bordered">
      <div class="portlet-title">
        <div class="caption"><i class="icon-settings font-dark"></i><span class="caption-subject font-dark sbold uppercase">菜单管理</span></div>
        <!--.actions
      ...
      <div class="portlet-body">
        <div ui-tree="">
          <ol ui-tree-nodes="" ng-model="menus">
            <li ng-repeat="item in menus" ui-tree-node="">
