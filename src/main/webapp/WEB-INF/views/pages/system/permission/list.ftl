  ...
  <div class="col-md-12">
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark"><i class="icon-settings font-dark"></i><span class="caption-subject bold uppercase"> 权限列表</span></div>
        <div class="actions">
      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          <div class="row">
            <div class="col-md-6">
              <div class="btn-group"><a id="addPermission" href="#/system/permission/add" class="btn sbold green"><i class="fa fa-plus"></i>新增权限</a></div>
            </div>
            <div class="col-md-6">
        ...
        <table id="tableList" class="table table-striped table-bordered table-hover table-checkable order-column">
          ...
          <tbody>
            <tr class="odd gradeX">
              ...
              <td></td>
              <td>
                <input type="checkbox" checked="" data-size="small" data-on-text="启用" data-off-text="禁用" data-on-color="info" data-off-color="success" class="make-switch"/>
              </td>
              <td class="center"><span class="label label-sm label-success">配置权限</span></td>
