    ...
    <div class="portlet light bordered">
      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          <div class="row">
            <div class="col-md-6">
              <div class="btn-group"><a id="addRole" href="#/system/role/add" class="btn sbold green"><i class="fa fa-plus"></i>新增角色</a></div>
            </div>
            <div class="col-md-6">
        ...
        <table id="tableList" class="table table-striped table-bordered table-hover table-checkable order-column">
          ...
          <tbody>
            <tr ng-repeat="role in roles" class="odd gradeX">
              <td>
              ...
              <td> {{role.forbidTime | date:'yyyy-MM-dd HH:mm:ss'}}</td>
              <td>
                <input type="checkbox" checked="" data-size="small" data-on-color="info" data-off-color="success" data-on-text="启用" data-off-text="禁用" class="make-switch"/>
              </td>
              <td class="center">
                <button ng-click="addPermission();" class="btn btn-xs btn-success">配置权限</button>
              </td>
              <td>
