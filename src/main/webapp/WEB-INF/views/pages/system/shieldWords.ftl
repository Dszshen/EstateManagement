...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li><a href="#/system/shieldWords">屏蔽词<i class="fa fa-angle-right"></i></a></li>
    <li>屏蔽词</li>
  </ul>
  <!--.page-toolbar
  ...
  <div class="col-md-12">
    <div class="portlet light portlet-fit portlet-form bordered">
      <div class="portlet-title">
        <div class="caption"><i class="icon-settings font-dark"></i><span class="caption-subject font-dark sbold uppercase">屏蔽词</span></div>
        <!--.actions
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  <label class="control-label col-md-1">屏蔽词</label>
                  <div class="col-md-9">
                    <textarea rows="5" name="words" placeholder="请输入屏蔽词,词语之间用英文逗号隔开" data-required="1" class="form-control"></textarea>
                  </div>
                </div>
              </div>
            </div>
