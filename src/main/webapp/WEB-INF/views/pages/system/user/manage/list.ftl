...
<div class="page-bar">
  <ul class="page-breadcrumb">
    ...
    <li><a href="#/system/user/list">用户管理<i class="fa fa-angle-right"></i></a></li>
    <li>用户列表</li>
  </ul>
  <!--.page-toolbar
  ...
  <div class="col-md-12">
    ...
    <div class="portlet light bordered">
      <div class="portlet-title">
        <div class="caption font-dark"><i class="icon-settings font-dark"></i><span class="caption-subject bold uppercase"> 用户列表</span></div>
        <div class="actions">
      ...
      <div class="portlet-body">
        <div class="table-toolbar">
          <div class="row">
            <div class="col-md-6">
              <div class="btn-group"><a id="addUser" href="#/system/user/add" ng-click="addUser();" class="btn sbold green"><i class="fa fa-plus"></i>新增用户</a></div>
            </div>
            <div class="col-md-6">
        ...
        <table id="tableList" class="table table-striped table-bordered table-hover table-checkable order-column">
          ...
          <tbody>
            <tr class="odd gradeX">
              ...
              <td> 12345678</td>
              <td> 2016-04-05 16:05:06</td>
              <td>
                <button ng-click="addRole();" class="btn btn-xs btn-success">添加角色</button>
              </td>
